functions {
  ...
  vector get_keq(matrix S, vector dgf, real temperature, int[] mic_to_met, vector water_stoichiometry){
    /*
  ...
  vector get_dgrs(matrix S, vector dgf, real temperature, int[] mic_to_met, vector water_stoichiometry){
    /*
