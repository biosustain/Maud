...
class Modifier:
    ...
    :param modifier_type: what is the modifier type: 'allosteric_activator', 'allosteric_inhibitor',
    'competitive inhibitor'
    """

    def __init__(self, metabolite: Metabolite, modifier_type: str = None):
        self.metabolite = metabolite
        self.allosteric = modifier_type in ["allosteric_inhibitor", "allosteric_activator"]
