...
def get_input_data(mi: MaudInput) -> dict:
    ...
    return {
        ...
        "N_competitive_inhibitor": len(mi.priors.inhibition_constant_priors),
        "N_allosteric_inhibitor": len(mi.priors.tense_dissociation_constant_priors),
        "N_allosteric_activator": len(mi.priors.relaxed_dissociation_constant_priors),
