...
real[] get_derived_quantities(real[] ode_metabolites, real[] known_reals){
  ...
  real afac = known_reals[18];
  real Vm7 = known_reals[19];
  real Vm8 = known_reals[20];
  real Vm11 = known_reals[21];
  real Vm14 = known_reals[22];
...
real[] get_fluxes(real[] ode_metabolites,
  ...
  real K2ADPg = kinetic_parameters[3];
  real K2ATPg = kinetic_parameters[4];
  real K2Glc6P = kinetic_parameters[5];
  real K2GlcI = kinetic_parameters[6];
  real Vm2 = kinetic_parameters[7];
  real K3Fru6P = kinetic_parameters[8];
  real K3Glc6P = kinetic_parameters[9];
  real Vm3 = kinetic_parameters[10];
  real K4ATPg = kinetic_parameters[11];
  real K4Fru6P = kinetic_parameters[12];
  real K4i1Fru16BP = kinetic_parameters[13];
  real K4i2Fru16BP = kinetic_parameters[14];
  real Vm4 = kinetic_parameters[15];
  real K5DHAP = kinetic_parameters[16];
  real K5GAP = kinetic_parameters[17];
  real K5GAPi = kinetic_parameters[18];
  real Vm5f = kinetic_parameters[19];
  real Vm5r = kinetic_parameters[20];
  real K6DHAPg = kinetic_parameters[21];
  real K6GAP = kinetic_parameters[22];
  real Vm6 = kinetic_parameters[23];
  real K7BPGA13 = kinetic_parameters[24];
  real K7GAP = kinetic_parameters[25];
  real K7NAD = kinetic_parameters[26];
  real K7NADH = kinetic_parameters[27];
  real Vm7f = kinetic_parameters[28];
  real Vm7r = kinetic_parameters[29];
  real K8DHAPg = kinetic_parameters[30];
  real K8Gly3Pg = kinetic_parameters[31];
  real K8NAD = kinetic_parameters[32];
  real K8NADH = kinetic_parameters[33];
  real Vm8f = kinetic_parameters[34];
  real Vm8r = kinetic_parameters[35];
  real K9Gly3Pc = kinetic_parameters[36];
  real Vm9 = kinetic_parameters[37];
  real K10Pyr = kinetic_parameters[38];
  real Vm10 = kinetic_parameters[39];
  real K11ADPg = kinetic_parameters[40];
  real K11ATPg = kinetic_parameters[41];
  real K11BPGA13 = kinetic_parameters[42];
  real K11PGA3 = kinetic_parameters[43];
  real Vm11f = kinetic_parameters[44];
  real Vm11r = kinetic_parameters[45];
  real K12ADP = kinetic_parameters[46];
  real Vm12 = kinetic_parameters[47];
  real n12 = kinetic_parameters[48];
  real K13 = kinetic_parameters[49];
  real K14ADPg = kinetic_parameters[50];
  real K14ATPg = kinetic_parameters[51];
  real K14Gly = kinetic_parameters[52];
  real K14Gly3Pg = kinetic_parameters[53];
  real Vm14f = kinetic_parameters[54];
  real Vm14r = kinetic_parameters[55];
