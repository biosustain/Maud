...
def test_linear():
    ...
    expected = {
        ...
        'keq[2]': [1.0, 1.0],
        'keq[3]': [1.0, 1.0],
        'yconc_sim[1]': [1.2966562, 2.0657183],
        'yconc_sim[2]': [1.1787578999999997, 1.8770003],
        'yconc_sim[3]': [1.7700946999999998, 2.3176564],
        'yconc_sim[4]': [0.87269654, 1.1228242],
        'yconc_sim[5]': [1.419334, 2.1580832],
        'yconc_sim[6]': [0.9637706799999999, 1.5308299],
        'yconc_sim[7]': [1.7649993000000002, 2.2607772999999995],
        'yconc_sim[8]': [0.8662747000000001, 1.1344169000000002],
        'yenz_sim[1]': [0.89214173, 1.1256323],
        'yenz_sim[2]': [0.86327175, 1.1408816],
        'yenz_sim[3]': [0.88699978, 1.1190514],
        'yenz_sim[4]': [1.3076868, 1.7061578],
        'yenz_sim[5]': [0.43829166, 0.58056403],
        'yenz_sim[6]': [1.3313091000000001, 1.6794179999999999],
        'yflux_sim[1]': [-0.072211948, 0.36258123],
        'yflux_sim[2]': [-0.085179098, 0.32160353999999997],
    ...
    dict(zip(samples_test.columns, map(list, samples_test.quantile([0.03, 0.97]).T.values)))
