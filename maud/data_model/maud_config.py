...
class MaudConfig:
    ...
    :param steady_state_threshold_sigma: dictionary of standard deviations for SV checks when reject_non_steady is false  # noqa: E501
    ...
    steady_state_threshold_sigma: float = 1e-8
